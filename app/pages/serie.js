    ...
    <div class="bg-gradient-to-r from-black via-red-500 to-black min-w-screen min-h-screen bg-gray-200 flex items-center justify-center bg-gray-100 font-sans overflow-hidden">
        <div class="w-full lg:w-5/6">
            <div class="bg-white shadow-md rounded my-6">
                <table class="border-separate border border-black min-w-max w-full table-auto">
                    <thead>
                        <tr class="bg-red-400 text-black-400 uppercase text-sm leading-normal">
                            ...
                            <th class="border-separate border border-black py-3 px-6 text-center">Temporada</th>
                            <th class="border-separate border border-black py-3 px-6 text-center">Episódio</th>
                    ...
                    <tbody class="text-gray-600 text-sm font-light">
                        <tr class="border-b border-gray-200 hover:bg-gray-100" v-for="item in dataSerie">
                            <td class="border border-black py-3 px-6 text-left whitespace-nowrap">
                                <div class="flex items-center">                                    
                                    <span class="font-medium">{{item.id}}</span>
                                </div>
                            </td>
                            <td class="border border-black py-3 px-6 text-left">
                                <div class="flex items-center">
                                    <span class="font-medium">{{item.nome}}</span>
                                </div>
                            </td>
                            <td class="border border-black py-3 px-6 text-center">
                                <div class="flex items-center">
                                    <span class="font-medium">{{item.temporada}}</span>
                                </div>
                            </td>
                            <td class="border border-black py-3 px-6 text-left">
                                <div class="flex items-center">
                                    <span class="font-medium">{{item.episodio}}</span>
                                </div>
                            </td>
                            <td class="border border-black py-3 px-6 text-left">
                                <div class="flex items-center">
                            ...
                            <td class="border border-black py-3 px-6 text-center">
                                <div class="flex item-center justify-center">
                                    <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                        <router-link :to="{name: 'VisualSerie', params: {id: item.id}}">
                                    ...
                                    <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                        <router-link :to="{name: 'EditarSerie', params: {id: item.id}}">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                        <router-link :to="{name: 'ExcluirSerie', params: {id: item.id}}">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="w-7 bg-gradient-to-r from-pink-500 to-yellow-500 hover:from-green-400 hover:to-blue-500" title="Voltar">
